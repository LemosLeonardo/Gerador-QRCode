                                 ...
                                 <div class="row border border-dark rounded mx-2 mt-3">
                                     ...
                                     <div class="col-md-4 col-sm-12">
                                         ...
                                         <div class="text-center pb-3">
                                             <?php
                                                $data = $url;
                                                echo '<img src="' . (new \chillerlan\QRCode\QRCode())->render($data) . '" alt="QR Code" width="200px"/>';
                                                ?>
                                     ...
                                     <!-- <div class="col-12">
                                     <h3>Informações sobre o recebimento da viatura:</h3>
                                    </div> -->
                                     <div class="col-md-8 col-sm-12">
                                         <div class="row">

                                             <div class=" col-md-6 col-sm-12">
                                                 <h5 class="mb-0">OM da Viatura:</h5>
                                                 <p><?php echo $omVtr ?></p>
                                             </div>

                                             <div class="  col-md-6 col-sm-12">
                                                 <h5 class="mb-0">Dada de Entrada:</h5>
                                                 <p><?php echo $dataEntrada ?></p>
                                             </div>
                                             <div class=" col-md-6 col-sm-12">
                                                 <h5 class="mb-0">Nome de Guerra:</h5>
                                                 <p><?php echo $nomeGuerra ?></p>
                                             </div>
                                             <div class=" col-md-6 col-sm-12">
                                                 <h5 class="mb-0">Identidade:</h5>
                                                 <p><?php echo $idt ?></p>
                                             </div>
                                             <div class=" col-12 ">
                                                 <h5 class="mb-0">Informações Iniciais:</h5>
                                                 <div>
                                                     <p class="text-justify">&nbsp; &nbsp;<?php echo $infIniciais ?></p>
                                                 </div>
                                             </div>
                                         </div>
                     ...
                     <div id="print" class="conteudo">
                         ...
                         <center>
                             ...
                             <table border="1" cellspacing=0 cellpadding=2>
                                 ...
                                 <tr>
                                     ...
                                     <th colspan="2">OM da Viatura</th>
                                     <th colspan="2">Dada de Entrada</th>
                                 </tr>
                                 <tr>
                                     <td colspan="2">
                                         <?php echo $omVtr ?>
                                 ...
                                 <tr>
                                     <th colspan="2">Nome de Guerra</th>
                                     <th colspan="2">
                                         Identidade
                                     </th>
                                 </tr>
                         ...
                         <center>
                             ...
                             <div class="text-center d-none">
                                 ...
                                 <?php
                                    $data = $url;
                                    echo '<img src="' . (new \chillerlan\QRCode\QRCode())->render($data) . '" alt="QR Code" width="300px"/>';
                                    ?>
                                 <h4 class=" text-center py-0 my-0">
                                     <?php echo $nomeVtr; ?>
                                 </h4>
